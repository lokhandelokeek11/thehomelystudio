  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover the story behind The Homely Studio—where authentic Indian crochet traditions, sacred deity decor, and cozy home aesthetics come to life." />
      </Helmet>
      ...
      <main className="min-h-screen bg-brand-bg py-12 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <SectionTitle
            ...
            description="The Homely Studio was born out of a profound love for traditional hand-knitting, sacred Indian festival rituals, and minimalist Scandinavian product aesthetics."
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-brand-muted font-light leading-relaxed">
                What began as a quiet household passion for knotting soft cotton yarns has blossomed into <strong>The Homely Studio</strong>—a boutique home brand dedicated to creating everlasting deity garlands (haar), sacred altar seating asaans, and cozy home accents.
              </p>

              <p className="text-brand-muted font-light leading-relaxed">
                Natural flowers, though sacred and breathtaking, wither away within hours. We wanted to offer devotees and home decor lovers an everlasting, respectful alternative crafted with high-bulk yarns that retain their vivid colors and shape across generations of festivals.
              </p>
              ...
              <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-brand-secondary/50 rounded-2xl border border-brand-border/60">
                  ...
                  <p className="text-xs text-brand-muted font-light">
                    To keep traditional crochet handicraft alive in modern homes while offering zero-waste, eco-conscious festive solutions.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4 pt-6">
                <div className="aspect-square rounded-2xl overflow-hidden shadow-soft border border-brand-border">
                  <img src={asaanImg} alt="Crochet Asaan Detail" className="w-full h-full object-cover" />
                </div>
                <div className="aspect-square rounded-2xl overflow-hidden shadow-soft border border-brand-border">
